...
public class PracticeapplicationApplication {
	...
	public CorsFilter corsFilter() {
		...
		UrlBasedCorsConfigurationSource urlconfigsrc = new UrlBasedCorsConfigurationSource();
		urlconfigsrc.registerCorsConfiguration("/**", corsConfiguration);
		return new org.springframework.web.filter.CorsFilter(urlconfigsrc);
	}
